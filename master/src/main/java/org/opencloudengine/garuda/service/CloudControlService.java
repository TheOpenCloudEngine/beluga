 ...
 */
public class CloudControlService extends AbstractService {
    public CloudControlService(Environment environment, Settings settings, ServiceManager serviceManager) {
