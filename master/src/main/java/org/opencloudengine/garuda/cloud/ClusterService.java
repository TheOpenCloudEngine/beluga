...
public class ClusterService extends AbstractService {
    ...
    public void createCluster(String clusterId, String iaasType, String definitionId) throws UnknownIaasProviderException, RunNodesException {
    ...
    public void loadCluster(String clusterId) throws UnknownIaasProviderException {
        ...
        String iaasType = settings.getString(ClusterTopology.IAAS_TYPE_KEY);
        if(iaasType == null) {
