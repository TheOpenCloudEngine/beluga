...
import org.opencloudengine.garuda.loadbalancer.LoadBalancer;
import org.opencloudengine.garuda.loadbalancer.LoadBalancerExtensionException;
import org.opencloudengine.garuda.loadbalancer.domain.Topology;
...
public class HAProxy implements LoadBalancer {
     ...
     * @param topology
     * @throws org.opencloudengine.garuda.loadbalancer.LoadBalancerExtensionException
     */
    ...
    public void stop() throws LoadBalancerExtensionException {
        ...
        try {
            ...
            for (String pid : pids) {
                ...
                CommandUtils.executeCommand(command);
                if (log.isInfoEnabled()) {
                    log.info("haproxy instance stopped [pid] {}", pid);
                }
            }
        } catch (Exception e) {
            if (log.isErrorEnabled()) {
