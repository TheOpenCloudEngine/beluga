...
import org.opencloudengine.bak.loadbalancer.LoadBalancer;
import org.opencloudengine.bak.loadbalancer.LoadBalancerExtensionException;
...
public class HAProxy implements LoadBalancer {
     ...
     * @param topology
     * @throws org.opencloudengine.bak.loadbalancer.LoadBalancerExtensionException
     */
